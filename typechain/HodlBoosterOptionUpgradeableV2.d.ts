...
interface HodlBoosterOptionUpgradeableV2Interface
  ...
  functions: {
    ...
    "initialize(address,address,(uint8,uint8,uint8,uint8,address,address,bool)[])": FunctionFragment;
...
export class HodlBoosterOptionUpgradeableV2 extends BaseContract {
  ...
  functions: {
    ...
    addWhitelistAddress(
      _target: string,
      _assets: string[],
      _allowedWithdrawAmounts: BigNumberish[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
