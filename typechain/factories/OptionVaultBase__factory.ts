...
import type {
  OptionVaultBase,
  OptionVaultBaseInterface,
} from "../OptionVaultBase";
...
export class OptionVaultBase__factory {
  static readonly abi = _abi;
  static createInterface(): OptionVaultBaseInterface {
    return new utils.Interface(_abi) as OptionVaultBaseInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OptionVaultBase {
    return new Contract(address, _abi, signerOrProvider) as OptionVaultBase;
  }
}
