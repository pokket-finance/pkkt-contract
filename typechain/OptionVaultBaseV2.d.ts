...
interface OptionVaultBaseV2Interface extends ethers.utils.Interface {
  functions: {
...
export class OptionVaultBaseV2 extends BaseContract {
  ...
  interface: OptionVaultBaseV2Interface;
